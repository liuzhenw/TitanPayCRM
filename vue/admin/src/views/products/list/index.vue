    ...
    <div id="container">
      <el-card shadow="never" class="art-table-card">
        <ArtTable row-key="id" :data="tableData" :loading="dataLoading">
          ...
          <el-table-column key="salesVolume" prop="salesVolume" label="销售量" align="right"  width="100"/>
          <el-table-column key="salesRevenue" prop="salesRevenue" label="销售额" align="right">
            <template #default="{ row }">
              {{ row.salesRevenue }} USD
            </template>
          </el-table-column>
          <el-table-column key="totalCommission" prop="totalCommission" label="总佣金" align="right">
            <template #default="{ row }">
